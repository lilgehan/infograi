...
/* ══════════════════════════════════════════════════════════
   PHASE 8 WAVE 3 — COMPOSITION RULES (Gamma-faithful)
   Wave 1 shipped the theme. Wave 2 shipped the visual hierarchy.
   Wave 3 polishes inside Gamma's existing patterns — does NOT
   invent new layouts.
   - Gutter: A1 inline titles cap at 78% width so the right side
     reads as deliberate negative space.
   - Tile polish: A1 priority tile rows fill more vertical space
     with taller, denser cards.
   - Circle-stats labels: word-count consistency rule (handled in
     the circle-stats validator + schema docs, not CSS).
   The hero-stat asymmetric layout was reverted — Gamma keeps
   circle-stats equal across the row, and so should we.
   ══════════════════════════════════════════════════════════ */

/* ── Editorial gutter on A1 hero titles ──
   The eyebrow + display title get a 78% max width so the right
